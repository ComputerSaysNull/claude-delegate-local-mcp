...
**Current phase:** M4 — Agentic loop and model tools — 6 of 10 items done
...
| M4 — Agentic loop and model tools | 6 | 0 | 4 | 0 |
| M5 — Sandbox | 0 | 0 | 8 | 0 |
...
**Overall:** 51 done, 20 open, 7 cancelled.

## Repository

- 40 commit(s), 88 tracked files
- 29 test file(s), 33 decision record(s)
